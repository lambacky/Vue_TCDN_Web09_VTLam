<template>
    <div class="paging">
        <div class="paging-left">
            <div class="record-sum">{{Text.total}}: <b>{{totalRecord}}</b> {{Text.record}}</div>
        </div>
        <div class="paging-right">
            ...
            <div class="page-button">
                <button :disabled="pageNumber==1" class="btn-prev" @click="selectPageNumber(pageNumber-1)">{{Text.prev}}</button>
                ...
                <button :disabled="pageNumber==totalPage" class="btn-next" @click="selectPageNumber(pageNumber+1)">{{Text.next}}</button>
            </div>                  
        </div>
    </div>
</template>
